...
const mongoose = require("mongoose"); //its is an object data modelling library  for Mongodb in node.js
...
app.use("*", cors()); // handles preflight requests for all routes
...
app.delete("/delete-story/:id", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    // Delete the image filr from the uploads folder
