...
// Removed the second import of MdOutlineDateRange
...
const DateSelector = ({ date, setDate }) => {
  ...
  return (
    <div>
      ...
      {openDatePicker && (
        <div className="overflow-y-scroll p-5 bg-sky-50 rounded-sm relative pt-4">
          <button
            className="w-10 h-10 rounded-full flex items-center justify-center bg-sky-100 hover:bg-sky-100 absolute top-2 right-0"
            onClick={() => {
